#!/usr/bin/env python3
"""
Final verification of x8Dsub-byte implementation
"""
...
if all_passed:
    ...
    print("")
    print("Installation: pip install git+https://github.com/bapXai/x8Dsub-byte.git#subdirectory=bindings/python")
    print("")
